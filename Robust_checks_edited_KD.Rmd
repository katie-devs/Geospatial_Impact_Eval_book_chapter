...
# 6)	Check the robustness of these results to alternative matching specifications
...
## 6a) Run the_parameters_loop to test the effect of varying the statistical distance measure and model parameters
...
## 6b) Run the_cov_loop to test the effect of including additional covariates
...
## 6c) Merge outputs from the two loops:
...
## 6e) Explore the remaining results. 
...
# 7) Run a fixed effects panel regression on data from all four offsets

## 7a) Load pre-prepared, matched datasets for the other three offsets, tidy and merge with Ankerana data
...
## 7b) Run the fixed effects panel regression
...
## 7c) Back-transform the estimates.
